...
const { testAndConnect } = require('../config/database');
...
const seedDatabase = async () => {
  try {
    ...
    console.log('[Seeder] Seeding database with realistic NEXORA COMPUTERS data...');
    ...
    console.log('[Seeder] Created default accounts (Admin: admin@nexora.com / Password123!)');
    ...
    console.log('[Seeder] Realistic products seeded successfully.');
    ...
    console.log('[Seeder] Sample repair ticket & quotation seeded successfully.');
    console.log('[Seeder] Complete database seeding finished!');
